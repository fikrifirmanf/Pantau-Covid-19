...
//
//     final kasusIndoModel = kasusIndoModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

KasusIndoModel kasusIndoModelFromJson(String str) =>
    KasusIndoModel.fromMap(json.decode(str));

String kasusIndoModelToJson(KasusIndoModel data) => json.encode(data.toMap());

class KasusIndoModel {
  List<Node> nodes;
  List<Link> links;
  ...
  factory KasusIndoModel.fromMap(Map<String, dynamic> json) => KasusIndoModel(
