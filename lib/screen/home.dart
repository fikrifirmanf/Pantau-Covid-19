                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    CardTitle(
                      ...
                      value: nf.format(
                              home.cases - (home.recovered + home.deaths)) ??
                          '',
                    ),
                    SizedBox(
                      height: 16.0,
                    ...
                    CardTitle(
                      stat: ((home.deaths /
                              ...
                              .isNaN)
                          ? '-%'
                          : (home.deaths / (home.recovered + home.deaths) * 100)
                                  .round()
                                  .toString() +
                              '%',
                    ...
                    GestureDetector(
                      ...
                      child: CardNegara(
                          ...
                          titleD: 'Meninggal',
                          titleR: 'Sembuh',
                          valueCtoday: indo.todayCases.toString(),
                          valueDtoday: indo.todayDeaths.toString(),
                          ...
                          valueA: (indo?.cases == null)
                              ? ''
                              : nf.format(
                                  indo.cases - (indo.recovered + indo.deaths) ??
                                      ''),
